  ...
  return (
    <section className="container mx-auto py-8">
      ...
      <p className="mb-6 text-lg">
        Welcome to my blog. Here, I share insights and analysis on energy, power, data analytics, and technology. Stay tuned for updates and deep dives into the trends shaping the energy sector.
      </p>
      <BlogPosts />
    </section>
  )
